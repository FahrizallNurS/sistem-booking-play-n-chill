<div class="modal fade" id="modalFormVideo" tabindex="-1" role="dialog" aria-labelledby="modalFormVideoLabel" aria-hidden="true">
                    ...
                    <div class="form-group">
                        ...
                        <div id="uploadDropzone"
                            ...
                            <div id="uploadPlaceholder" class="text-center" style="color: #6b7280;">
                                ...
                                <p class="mb-0" style="font-size: 0.95rem; color: #374151;">Upload Thumbnail Max 2MB</p>
...
document.addEventListener('DOMContentLoaded', function () {
    const inputGambar = document.getElementById('input_thumbnail_video');
