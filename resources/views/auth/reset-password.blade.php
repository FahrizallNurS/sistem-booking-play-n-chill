...
<head>
  ...
  <title>Play N Chill | Reset Password</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .desc {
      ...
      font-size: 0.9rem; margin-bottom: 28px; line-height: 1.6;
    }
    ...
    .input-group input {
      ...
      outline: none; transition: border-color 0.2s, box-shadow 0.2s; color: #333;
    }
    ...
    .back-link { text-align: center; font-size: 0.95rem; color: #666; }
    .back-link a { color: #7c4dff; font-weight: 700; text-decoration: none; }
...
<div class="login-box">
  ...
  <p class="desc">Masukkan password baru kamu.</p>
